...
static const _Trama_type_support_symbol_names_t _Trama_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, extra_interfaces, msg, Trama)),
  }
};
...
{
#endif
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, extra_interfaces, msg, Trama)();
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, extra_interfaces, msg, Trama)();
#ifdef __cplusplus
}
#endif
...
static _Trama_type_support_data_t _Trama_message_typesupport_data = {
  {
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, extra_interfaces, msg, Trama),
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, extra_interfaces, msg, Trama),
  }
};
#else
static _Trama_type_support_data_t _Trama_message_typesupport_data = {
...
static rosidl_message_type_support_t Trama_message_type_support_handle = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, extra_interfaces, msg, Trama)() {
  if (!::extra_interfaces::msg::rosidl_typesupport_c::Trama_message_type_support_handle.typesupport_identifier) {
    ::extra_interfaces::msg::rosidl_typesupport_c::Trama_message_type_support_handle.typesupport_identifier =
    rosidl_typesupport_c__typesupport_identifier;
  }
