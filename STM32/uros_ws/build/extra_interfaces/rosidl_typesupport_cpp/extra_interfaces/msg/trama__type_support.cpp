...
static const _Trama_type_support_symbol_names_t _Trama_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, extra_interfaces, msg, Trama)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, extra_interfaces, msg, Trama)),
  }
};
...
{
  return &::extra_interfaces::msg::rosidl_typesupport_cpp::Trama_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, extra_interfaces, msg, Trama)() {
  return get_message_type_support_handle<extra_interfaces::msg::Trama>();
}
