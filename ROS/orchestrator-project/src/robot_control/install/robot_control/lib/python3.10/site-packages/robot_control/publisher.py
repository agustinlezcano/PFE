...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        #:M2A100V500 Motor 2 a 100 absoluto velocidad 500
        # msg = String()  # esto lo defino en el timer 
        # msg.data = ":M2A100V500" # luego se pueden enviar más valores
        # self.publisher_ = self.create_publisher(String, 'topic', 10)
        # self.publisher_ = self.create_publisher(WString, '/microROS/int32_subscriber', 2)
        # self.publisher_ = self.create_publisher(Trama, '/microROS/int32_subscriber', 10)
        ...
        #self.timer_cmd = self.create_timer(5, self.timer_callback) 
